...
public class DialogUtil {
    ...
    public void showBankUpDialog(Context context, boolean outAble, String content, final OnBankClickListener listener) {
        ...
        final TextView tvBankUpdataTitle = (TextView) view.findViewById(R.id.tv_bank_updata_title);
     ...
     * @param finish
     */
    public void setUpdataBankDialogProgress(Progress progress, boolean finish) {
        if (finish) {
            if (mShow != null && mShow.isShowing()) {
                mShow.dismiss();
                return;
