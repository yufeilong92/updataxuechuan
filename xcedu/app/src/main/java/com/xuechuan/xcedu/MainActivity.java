...
import com.xuechuan.xcedu.sqlitedb.DbPathUitl;
...
/*                EncrypVo vo = FileUtil.getSaveEncryTag();
            ...
            case R.id.btn_play_get:
                DbPathUitl pathUitl = DbPathUitl.get_Instance(mContext);
                String dbPath = pathUitl.getDbPath();
                String concat = dbPath.concat("questions.db" );
                selectInfom(concat);
